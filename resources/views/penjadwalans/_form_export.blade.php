...
<div class="form-group{{ $errors->has('dari_tanggal') ? ' has-error' : '' }}">
		...
		{!! Form::text('dari_tanggal', null, ['class'=>'form-control datepicker_filter','required','autocomplete'=>'off','placeholder' => 'Dari Tanggal']) !!}
...
<div class="form-group{{ $errors->has('sampai_tanggal') ? ' has-error' : '' }}">
		...
		{!! Form::text('sampai_tanggal', null, ['class'=>'form-control datepicker_filter','required','autocomplete'=>'off','placeholder' => 'Sampai Tanggal']) !!}
