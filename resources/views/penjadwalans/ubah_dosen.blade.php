		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumb">
					...
					<li class="active">Edit Ubah Dosen</li>
				</ul>

				<div class="panel panel-default">
					<div class="panel-heading">
						<h2 class="panel-title">Edit Ubah Dosen</h2>
					</div>

					<div class="panel-body">    
					<!-- MENAMPILKAN DATA PENJDWALAN SESUAI ID YANG DI KIRIM -->
						{!! Form::model($penjadwalans, ['url' => route('penjadwalans.proses_ubah_dosen', $penjadwalans->id), 'method' => 'put', 'files'=>'true','class'=>'form-horizontal']) !!}
